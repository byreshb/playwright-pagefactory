...
public enum How {
  ...
  /** {@link By#css(String)} */
  CSS {
    @Override public By buildBy(String value) { return By.css(value); }
  },
  /** {@link By#id(String)} */
  ID {
  ...
  ID_OR_NAME {
    @Override public By buildBy(String value) { return By.idOrName(value); }
  },
  ...
  SELECTOR {
    @Override public By buildBy(String value) { return By.selector(value); }
  },
  /** {@link By#testId(String)} */
  TEST_ID {
    @Override public By buildBy(String value) { return By.testId(value); }
  },
  /** {@link By#text(String)} */
  TEXT {
    @Override public By buildBy(String value) { return By.text(value); }
  },
  /** {@link By#label(String)} */
  LABEL {
    @Override public By buildBy(String value) { return By.label(value); }
  },
  /** {@link By#placeholder(String)} */
  PLACEHOLDER {
    @Override public By buildBy(String value) { return By.placeholder(value); }
  },
  /** {@link By#altText(String)} */
  ALT_TEXT {
    @Override public By buildBy(String value) { return By.altText(value); }
  },
  /** {@link By#title(String)} */
  TITLE {
    @Override public By buildBy(String value) { return By.title(value); }
  },
